...
def train_valid_generator(
    ...
    datagenerator_kawargs = dict(rescale=1.0/255, validation_split=0.20)
    ...
    valid_generator = valid_datagenerator.flow_from_directory(
        directory=data_dir, subset="validation", shuffle=False, **dataflow_kawargs
    )
    ...
    train_generator = train_datagenerator.flow_from_directory(
        directory=data_dir, subset="training", shuffle=True, **dataflow_kawargs
    )
